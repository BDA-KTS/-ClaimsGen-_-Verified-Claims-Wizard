...
def usage():
    """
    Displays the help text from the "exporter_help_text.txt" file.
    """
...
if __name__ == '__main__':
    ...
    configuration_dict = config_dict = yaml.load(open("configuration.yaml.sample", "r"), Loader=yaml.Loader)
